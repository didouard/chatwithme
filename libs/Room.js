...
var Room = function () {
  ...
  this.addMessage = function (data, callback) {
    ...
    var loadData = function (callback) {
      var getMessage = function (callback) { return data.message.getMessage(null, callback); };
      var getUsername = function (callback) { return data.user.getName(null, callback); };
    
      var jobs = {message: getMessage, username: getUsername};
    ...
    var saveInModel = function (params, callback) {
      return model.saveMessage(params, function (err) {
        if (err) return callback(err);
        return callback(null, params);
      });
    };
  ...
  this.serializeAll = function (data, callback) {
    ...
    var jobs = {serializeMessages: serializeMessages, serializeUsers: serializeUsers};
    async.parallel(jobs, function (err, results) {
      if (err) return callback(err);
